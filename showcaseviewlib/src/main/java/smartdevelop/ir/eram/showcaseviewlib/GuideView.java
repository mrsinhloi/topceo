...
public class GuideView extends FrameLayout {
    ...
    private GuideView(Context context, View view) {
        ...
        targetRect = new RectF(locationTarget[0], locationTarget[1],
...
//        params.bottomMargin = messageViewPadding;
        ...
        ViewTreeObserver.OnGlobalLayoutListener layoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                targetRect = new RectF(locationTarget[0],
                        locationTarget[1] - cutoutHeight,
                        locationTarget[0] + target.getWidth(),
                        locationTarget[1] + target.getHeight() - cutoutHeight);
                ...
                stopY = yMessageView + indicatorHeight + (isTop ? 0 : 220);
                startAnimationSize();
        ...
        if (!isPerformedAnimationSize) {
            ...
            circleSizeAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    if (circleIndicatorSize < 0) circleIndicatorSize = -circleIndicatorSize;
                    postInvalidate();
                }
            });
    ...
    public static class Builder {
        ...
        public Builder(Context context, int cutoutHeight) {
        ...
        /**
         * setting fonts type face
         *
         * @param typeFace a instance of type face (fonts family)
         **/
        ...
        public GuideView build() {
            ...
            if (cutoutHeight != 0) {
                guideView.cutoutHeight = cutoutHeight;
            }
