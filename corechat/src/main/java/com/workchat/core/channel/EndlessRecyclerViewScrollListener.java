 ...
 * Created by MrPhuong on 2016-07-20.
 */
...
//        MyUtils.log("isScrollUp = "+mIsScrollingUp);
        onDetectScroll(mIsScrollingUp);
    ...
    public abstract void onDetectScroll(boolean isScrollUp);
