package com.workchat.core.activities.base
...
abstract class BaseActivityWc : AppCompatActivity(), CoroutineScope by MainScope() {
    val prefs: SharedPreferences by lazy { PreferenceManager.getDefaultSharedPreferences(this@BaseActivityWc) }
