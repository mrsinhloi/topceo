 ...
 */
public class MH28_File_Send_In_Chat extends Fragment {
    ...
    public static MH28_File_Send_In_Chat newInstance(String param1) {
        MH28_File_Send_In_Chat fragment = new MH28_File_Send_In_Chat();
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    private MH28_File_Send_In_Chat_Adapter adapter;
    ...
    private void getRoomFiles(String roomId, String lastLogId) {
        ...
        try {
            ...
            mSocket.emit("getRoomFiles", obj, new Ack() {
                            ...
                            public void run() {
                                ...
                                if (list != null && list.size() > 0) {
                                    if (TextUtils.isEmpty(lastLogId)) {
                                        //page dau tien
                                        adapter = new MH28_File_Send_In_Chat_Adapter(context, list);
