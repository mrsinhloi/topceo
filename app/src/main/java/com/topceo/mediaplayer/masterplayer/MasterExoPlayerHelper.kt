package com.topceo.mediaplayer.masterplayer
...
class MasterExoPlayerHelper(
    ...
    init {
        ...
        exoPlayerHelper.setListener(false, object : ExoPlayerHelper.Listener {
        ...
        override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
            ...
            when (newState) {
                RecyclerView.SCROLL_STATE_IDLE -> {
                    ...
                    for (i in 0 until visibleCount) {
                        val view = recyclerView.getChildAt(i) ?: continue
                        val offset = visibleAreaOffset(view)

                        if (offset >= playStrategy) {
                            val masterExoPlayer = view.findViewById<View>(id)
                            if (masterExoPlayer != null && masterExoPlayer is MasterExoPlayer) {
                                play(view)
                            } else {
