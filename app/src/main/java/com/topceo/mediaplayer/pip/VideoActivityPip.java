 ...
 * @author 刘振林
 */
public class VideoActivityPip extends SwipeBackActivity implements IVideoView {

    private static WeakReference<VideoActivityPip> sActivityInPiP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mPresenter.initPlaylist(savedInstanceState, getIntent())) {
            ...
            setContentView(R.layout.pip_activity_video);
    ...
    private void initViews(Bundle savedInstanceState) {
        ...
        mVideoView.setEventListener(new TextureVideoView.EventListener() {
            ...
            public void onShareVideo() {
                Context context = VideoActivityPip.this;
        ...
        mVideoView.setOpCallback(new TextureVideoView.OpCallback() {
            ...
            public Window getWindow() {
                return VideoActivityPip.this.getWindow();
            }

            @NonNull
            @Override
            public Class<? extends Activity> getHostActivityClass() {
                return VideoActivityPip.this.getClass();
            }
    ...
    protected void onStart() {
        ...
        if (sActivityInPiP != null) {
            VideoActivityPip activity = sActivityInPiP.get();
            if (activity != this) {
