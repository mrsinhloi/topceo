 ...
 * @author 刘振林
 */
public class VideoListActivityPip extends SwipeBackActivity implements IVideoView {
    private static WeakReference<VideoListActivityPip> sActivityInPiP;
    ...
    private void initViews(Bundle savedInstanceState) {
        ...
        mVideoView.setEventListener(new TextureVideoView.EventListener() {
            ...
            public void onShareVideo() {
                Context context = VideoListActivityPip.this;
        ...
        mVideoView.setOpCallback(new TextureVideoView.OpCallback() {
            ...
            public Window getWindow() {
                return VideoListActivityPip.this.getWindow();
            }

            @NonNull
            @Override
            public Class<? extends Activity> getHostActivityClass() {
                return VideoListActivityPip.this.getClass();
            }
    ...
    protected void onStart() {
        ...
        if (sActivityInPiP != null) {
            VideoListActivityPip activity = sActivityInPiP.get();
            if (activity != this) {
