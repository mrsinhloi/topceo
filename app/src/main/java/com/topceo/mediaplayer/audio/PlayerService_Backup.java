 ...
 */
@Deprecated
public class PlayerService_Backup extends Service {
    ...
    public class MyBinder extends Binder {
        public PlayerService_Backup getService() {
            return PlayerService_Backup.this;
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            if (intent.getExtras() != null) {
                ...
                //thong bao cho cac man hinh bind service load lai du lieu moi
