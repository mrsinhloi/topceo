...
public class Fragment_Explorer_People extends Fragment {

    public Fragment_Explorer_People() {}
    @Override
...
//        ProgressUtils.show(context);
        Webservices.searchTop(keyword, context,"search/people").continueWith(new Continuation<Object, Void>() {
            @Override
