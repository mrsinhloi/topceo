...
public class Fragment_Explorer_Top extends Fragment {

    public Fragment_Explorer_Top() {}
    @Override
...
//        ProgressUtils.show(context);
        Webservices.searchTop(keyword, context,"search/top").continueWith(new Continuation<Object, Void>() {
            @Override
