package com.topceo.socialview.core.widget;
 ...
 *
 */
public class SocialTextViewExpand extends AppCompatTextView implements SocialView {

    private final SocialView impl;

    public SocialTextViewExpand(Context context) {
        this(context, null);
    }

    public SocialTextViewExpand(Context context, AttributeSet attrs) {
...
//                requestFocusFromTouch();
    ...
    public SocialTextViewExpand(Context context, AttributeSet attrs, int defStyleAttr) {
