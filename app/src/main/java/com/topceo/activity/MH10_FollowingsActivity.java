...
public class MH10_FollowingsActivity extends AppCompatActivity {
...
//        tv.setItemAnimator(new DefaultItemAnimator());
        rv.addOnScrollListener(new EndlessRecyclerViewScrollListener(mLayoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount) {
                ...
                if (follower != null) {
                    getUserFollowings(userId, follower.getUserId(), follower.getCreateDate());
                }
            }
        });
     ...
     * @param lastItemId
     */
    private void getUserFollowings(final long userId, final long lastItemId, final long lastCreateDate) {
        Webservices.getListUserFollowing(userId, lastItemId, lastCreateDate).continueWith(new Continuation<Object, Void>() {
            @Override
...
//                    MyUtils.showToast(context, task.getError().getMessage());
                        ...
                        MyApplication.initCookie(context).continueWith(new Continuation<Object, Void>() {
                            ...
                            public Void then(Task<Object> task) throws Exception {
                                if (task.getResult() != null) {
                                    ...
                                    if (kq != null) {
                                        getUserFollowings(userId, lastItemId, lastCreateDate);
                                    }
                                }
                                return null;
                            }
    ...
    private void setTitleBar() {
        title.setText(getText(R.string.following_title));
