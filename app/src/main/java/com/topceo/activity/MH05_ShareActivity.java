...
import com.topceo.objects.image.ImageShare;
...
public class MH05_ShareActivity extends AppCompatActivity {
    ...
    private void init() {
        initAdapter();
        if (item != null) {
            getShares(item.getImageItemId(), 0, 0);
        }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    private ArrayList<ImageShare> listComments = new ArrayList<>();
...
//                customLoadMoreDataFromApi(page);
                ImageShare comment = mAdapter.getLastestItem();
                if (comment != null) {
                    getShares(item.getImageItemId(), comment.getItemId(), comment.getCreateDate());
                }
            }
        });
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        private ArrayList<ImageShare> mDataset = new ArrayList<>();
...
//                txt5.setInterpolator(new OvershootInterpolator());
        ...
        public void add(int position, ImageShare item) {
        ...
        public MyAdapter(ArrayList<ImageShare> myDataset) {
            mDataset = myDataset;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            final ImageShare item = mDataset.get(position);
            ...
            holder.txt1.setText(mDataset.get(position).getUser().getUserName());
            holder.txt2.setText(mDataset.get(position).getUser().getFullName());

            holder.img1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    MyUtils.gotoProfile(mDataset.get(position).getUser().getUserName(), context);
                }
            });
            ...
            final UserShortDB uLike = mDataset.get(position).getUser();
...
//                                            MyUtils.showToast(context, R.string.update_success);
            ...
            if (uLike.getUserId() == user.getUserId()) {
                ...
                /*if (uLike != null) {
                    if (MyUtils.isFollowing(uLike.getUserId())) {//da quan tam
                        ...
                        btn.setTextColor(getResources().getColor(R.color.blue_500));
                    }
                }*/
            }
        }
        ...
        //add list items
        public void addAll(ArrayList<ImageShare> list) {
            mDataset.addAll(list);
            notifyDataSetChanged();
        }

        public ImageShare getLastestItem() {
            ImageShare item = null;
            if (getItemCount() > 0) {
...
////////////////////////////////////////////////////////////////////////////////////////////
     ...
     * @param lastItemId
     */
    private void getShares(final long imageItemId, final long lastItemId, final long lastCreateDate) {
        String query = Webservices.GET_SHARES(imageItemId, lastItemId, lastCreateDate);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONObject obj = objP.getJSONObject("ImageComment");
                            JSONArray arr = obj.getJSONArray("Shares");

                            Type type = new TypeToken<List<ImageShare>>() {
                            }.getType();
                            ArrayList<ImageShare> comments = new Gson().fromJson(arr.toString(), type);
...
//                                MyUtils.showToastDebug(getApplicationContext(), ""+comments.size());
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArrayList(ImageShare.ARRAY_LIST, mAdapter.mDataset);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            ArrayList<ImageShare> list = savedInstanceState.getParcelableArrayList(ImageShare.ARRAY_LIST);
